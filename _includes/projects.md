...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    {% if link.image %}
    {% if link.details %}
    <a href="#" class="project-modal-trigger" data-project-id="proj-{{ forloop.index }}"><img src="{{ link.image }}" class="teaser img-fluid z-depth-1" style="width=100;height=40%"></a>
    {% else %}
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      <div class="title">
        {% if link.details %}
        <a href="#" class="project-modal-trigger" data-project-id="proj-{{ forloop.index }}">{{ link.title }}</a>
        {% else %}
